const requirement = {
  ...
  'requirement.detail.tab.overview': 'Overview',
  'requirement.detail.tab.work': 'Phases & tasks',
  'requirement.detail.tab.agents': 'Agents & pipeline',
  'requirement.detail.currentPhase': 'Current phase',
  'requirement.detail.goToWork': 'View phases & tasks',
  'requirement.detail.overviewHint': 'Use Phases & tasks to pick a stage and manage its task list.',
