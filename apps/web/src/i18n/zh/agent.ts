const agent = {
  ...
  'agent.name.requirement': '小娜助手',
  'agent.name.design': '小娜助手',
  'agent.name.architecture': '小娜助手',
  'agent.name.development': '小娜助手',
  'agent.name.testing': '小娜助手',
  'agent.name.cicd': '小娜助手',
  'agent.name.monitoring': '小娜助手',
  'agent.name.pm': '小娜助手',
  ...
  'nlp.homeAssistantPanel': '小娜助手',
  'nlp.workspaceAssistantPanel': '小娜助手',
  ...
  'nlp.homeGuide.template.prompt':
    '我想新建工作空间，名称「示例项目」，用于做一个团队内部协作小工具；首批需求「MVP 范围」——列一下第一期要交付的主要功能。',
